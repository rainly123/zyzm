...
<script type="text/javascript" src="/Public/static/uploadify/jquery.uploadify.min.js"></script>
    <div class="main-title">
        <h2><?php echo ($data['id']?'编辑':'新增'); ?>信息</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="url" value="<?php echo ((isset($data["url"]) && ($data["url"] !== ""))?($data["url"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">描述<span class="check-tips">不显示</span></label>
            <div class="controls">
                <textarea cols="80" rows="6" name="description"><?php echo ($data["description"]); ?></textarea>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">排序<span class="check-tips">数字越大越靠前</span></label>
            <div class="controls">
                <input type="text" class="text" name="sort" value="<?php echo ((isset($data["sort"]) && ($data["sort"] !== ""))?($data["sort"]):'0'); ?>">
            </div>
        </div>
        <div class="form-item">
