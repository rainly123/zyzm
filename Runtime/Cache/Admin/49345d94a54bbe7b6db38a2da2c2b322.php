...
<head>
    ...
    <link href="/jm2/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    
    <link rel="stylesheet" type="text/css" href="/jm2/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/jm2/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/jm2/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/jm2/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/jm2/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/jm2/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/jm2/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/jm2/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
    
	<link rel="stylesheet" href="/jm2/Public/Admin/js/codemirror/codemirror.css">
	<link rel="stylesheet" href="/jm2/Public/Admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
	<style>
		...
		#preview_window.loading{
			background: url('/jm2/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
'model'=>'Example',		//要查的表
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/jm2", //当前网站地址
            "APP"    : "/jm2/admin.php?s=", //当前项目地址
            "PUBLIC" : "/jm2/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/jm2/Public/static/think.js"></script>
    <script type="text/javascript" src="/jm2/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
	...
	<script type="text/javascript" src="/jm2/Public/Admin/js/codemirror/codemirror.js"></script>
	<script type="text/javascript" src="/jm2/Public/Admin/js/codemirror/xml.js"></script>
	<script type="text/javascript" src="/jm2/Public/Admin/js/codemirror/javascript.js"></script>
	<script type="text/javascript" src="/jm2/Public/Admin/js/codemirror/clike.js"></script>
	<script type="text/javascript" src="/jm2/Public/Admin/js/codemirror/php.js"></script>

	<script type="text/javascript" src="/jm2/Public/static/thinkbox/jquery.thinkbox.js"></script>
