...
<script type="text/javascript" src="/Public/static/uploadify/jquery.uploadify.min.js"></script>
    ...
    <input type="hidden" name="id" value="<?php echo ($project["id"]); ?>">
        <div class="form-item">
            <label class="item-label">项目名称：<?php echo ($project["project_name"]); ?></label>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
              ...
              <div class="upload-img-box">
                <?php if(!empty($project["barcode"])): ?><div class="upload-pre-item"><img src="<?php echo ($project["barcode"]); ?>"/></div><?php endif; ?>
              </div>
            </div>
        </div>
        <div class="form-item">
...
<script type="text/javascript">
//导航高亮
highlight_subnav('<?php echo U('Project/stage');?>');
