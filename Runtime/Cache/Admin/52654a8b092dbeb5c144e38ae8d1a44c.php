...
<body>
    ...
    <!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('memberlist');?>"><i class="btn-search"></i></a>
			</div>
		</div>
    </div>
    <!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td>
					<div class="btn-group ">
						<a href="<?php echo U('realname?id='.$vo['id']);?>" class="btn realname">实名认证</a>
					</div>
			    </td>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Member/memberlist');?>');
