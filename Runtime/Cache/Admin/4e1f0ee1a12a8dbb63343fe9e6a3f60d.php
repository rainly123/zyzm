    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
     	...
     	<div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="real_name" value="">
            </div>
        </div>
        <div class="form-item">
		...
		<?php if($oid == 0): ?><div class="form-item">
	            <label class="item-label">所属机构</label>
	            <div class="controls">
	     ...
	     <?php else: ?>
			<div class="form-item">
	            <label class="item-label">所属职位</label>
	            <div class="controls">
	            	<label><input type="radio" name="position" value="1">员工</label>
	                <label><input type="radio" name="position" value="2">经理</label>
	            </div>
	        </div><?php endif; ?>
