...
<div class="investor">
	<ul>
		<?php if(is_array($supportlist)): foreach($supportlist as $key=>$vo): ?><li>
         		<em><a href="<?php echo U('MCenter/profile?id='.$vo['uid']);?>" class="user">
            		<img src="<?php echo (get_memberface($vo["uid"])); ?>" width="50" height="50"></a>
            	</em>
          		<span class="investor-username"><?php echo (get_membername($vo["uid"])); ?></span>
         		<span class="invest-amount">投资金额: <strong><?php echo ($vo["amount"]); ?></strong>元</span>
