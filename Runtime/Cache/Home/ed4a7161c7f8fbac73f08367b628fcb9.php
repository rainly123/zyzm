...
<div class="fl w100 usermain mt15">
  ...
  <ul>
    ...
    <li class="cur"><a href="<?php echo U('User/addrlist');?>">配送地址</a></li>
...
<div class="userright ri">
  <div class="adresslist mt20 cl">
    <h2>配送地址 <a href="<?php echo U('User/modify_addr');?>" id="addnew" style="font-size:14px">添加派送地址</a></h2>
    <ul>
      <?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($vo["status"]) == "1"): ?>class="cur"<?php endif; ?>><table><tr>
        ...
        <td>
          <?php if(($vo["status"]) != "1"): ?><a href="<?php echo U('User/defaultaddr?addId='.$vo['id']);?>" class="defaut_addr">设置默认</a> |<?php endif; ?>
      ...
      </tr></table></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
  </div>
