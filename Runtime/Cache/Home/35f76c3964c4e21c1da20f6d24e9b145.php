...
<script>
    ...
    <div class="fl w100 mt25 dt">
        <div class="content border1">
            <div class="dtmain cl">
                <dl class="top">
                    <dt><img src="<?php echo (get_cover($projectInfo["cover"],'path')); ?>" alt="<?php echo ($projectInfo["project_name"]); ?>" width="310" height="186"></dt>
                    <dd>
                        <b><?php echo ($projectInfo["project_name"]); ?></b>
                        <a href="<?php echo U('/project/dynamiclistadd',array('id'=>$_GET['id']));?>" class="add">添加动态</a>
                    </dd>
                </dl>
            </div>
            <div class="dtlist cl">
                ...
                <ul>
                    <?php if(is_array($dynamicInfo)): foreach($dynamicInfo as $key=>$vo): ?><li>
                            <dl>
                                <dt><?php echo (time_format($vo["update_time"],'Y-m-d')); ?><br><?php echo (time_format($vo["update_time"],'H:i')); ?></dt>
                                <dd class="dd-link" data-href="<?php echo U('Project/projectdynamicdetail/id/'.$vo['id'].'.html');?>">
                                    <b><?php echo ($vo["title"]); ?></b>
                                    <p><?php echo mb_substr(strip_tags($vo['content']), 0,100,'utf-8');?></p>
                                    <div class="goto">
                                    <?php if($vo["status"] == 0): ?><a href="<?php echo U('Project/updateProjectDynamicStatus');?>" class="btn-publish" data-id="<?php echo ($vo["id"]); ?>" data-pid="<?php echo ($vo["project_id"]); ?>">发布</a><?php endif; ?>
                                        <a href="<?php echo U('Project/updateProjectDynamicInfo/id/'.$vo['id']);?>">编辑</a>
                                        <a class="delete_dynamic" href="<?php echo U('Project/dynamiclistdelete',array('id'=>$vo['id'],'pid'=>$_GET['id']));?>">删除</a>
                                    </div>
                                </dd>
                            </dl>
