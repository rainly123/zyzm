            ...
            <div class="register-form-container">
                ...
                <div class="register-form-container-inner">
                    ...
                    <div class="register-item-container">
                        ...
                        <input type="text" name="verify" class="register-input usericon3" placeholder="短信验证码"
                               style="width:160px;"
                    ...
                    <div style="width: 298px; height:36px; line-height:36px; font-size:14px; color:#959595;">
                        ...
                        <span>我同意</span><a href="<?php echo U('Info/show?key=agreement');?>" title="聚募网用户服务协议"
                                           style="color:#5ba8ea;">《中瀛众创网用户服务协议》</a></div>
                    <button type="submit" class="register-submit">立即注册</button>
                    <p style="text-align: center;padding-top: 20px;">已有账号<a style="color:#72c2e5; font-size:18px;"
