...
<script>
    ...
    <div class="fl w100 mt25 notice_main">
        <div class="content">
            ...
            <div class="rightmain">
                ...
                <div class="mainintro p-news-list">
                    <ul>
                        <?php if(is_array($lists)): foreach($lists as $key=>$v): ?><li class="item" data-id="<?php echo ($v["id"]); ?>">
                                <a href="<?php echo U('Info/infomation?id='.$v['id']);?>" title="新闻资讯"><?php echo ($v["title"]); ?></a><em><?php echo (time_format($v["create_time"],'Y-m-d')); ?></em></a>
    ...
    <script src="/Public/Home/js/red-dot.js"></script>
    <script>
        redDot.init('news')
    </script>
