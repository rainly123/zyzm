        ...
        <div class="content" id="detail">
            ...
            <div class="topinfo mt15 cl">
                ...
                <div class="infos ri">
                    ...
                    <dl class="rzxx cl">
                        <dd><span><?php echo ($resultSupport); ?></span>支持人数</dd>
                        <dd><span><?php
 if ($days - floor((time()-$start_time)/86400) >0) { print $days - floor((time()-$start_time)/86400) ;} else { print 0;} ?>天</span>剩余天数
                        </dd>
                        <dd><span><?php echo ($finish_progress_num); ?>%</span>已完成</dd>
                    </dl>
                    ...
                    <div class="cz cl">
                        ...
                        <div class="yzje"><b>￥<?php echo round($finish_amount);?></b>已筹金额</div>
                    </div>
                </div>
            </div>
            <div class="tagsbar">
                        ...
                        <div class="tjxm_body">
                            <div class="bx_wrap">
                                ...
                                <div class="bx_container">
                                    <!--<ul id="tjxm">
                                        <?php if(is_array($recomendList['project'])): foreach($recomendList['project'] as $key=>$v): ?><li><a href="<?php echo U('project/detail?id='.$v['id']);?>" title="中瀛智募"><img src="<?php echo (get_cover($v['cover'],'path')); ?>"  alt="<?php echo ($v["project_name"]); ?>股权众筹"><?php echo ($v["project_name"]); ?></a></li><?php endforeach; endif; ?>
                                        <?php if(is_array($recomendList['product'])): foreach($recomendList['product'] as $key=>$v): ?><li><a href="<?php echo U('product/viewdetail/pid/'.$v['id']);?>" title="中瀛智募"><img src="<?php echo (get_cover($v['home_img'],'path')); ?>"  alt="<?php echo ($v["name"]); ?>实物众筹"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
                                    </ul>-->

                                    <ul id="tjxm">
                                        <?php if(is_array($recomendList['project'])): foreach($recomendList['project'] as $key=>$v): ?><li><a href="<?php echo U('project/detail?id='.$v['id']);?>" title="中瀛智募"><img
                                                    src="<?php echo (get_cover($v['cover'],'path')); ?>"><?php echo ($v["project_name"]); ?></a></li><?php endforeach; endif; ?>
                                        <?php if(is_array($recomendList['product'])): foreach($recomendList['product'] as $key=>$v): ?><li><a href="<?php echo U('product/viewdetail?pid='.$v['id']);?>" title="中瀛智募"><img
