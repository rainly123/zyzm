...
<div class="fl w100 usermain mt15">
    ...
    <ul>
        <li class="cur"><a href="<?php echo U('User/detail');?>">个人资料</a></li>
                ...
                <li>
                    <dl>
                        ...
                        <dd><input name="user[nickname]" type="text" placeholder="请输入你的昵称" datatype="s1-30"
                                   maxlength="30"
                                   nullmsg="请输入您的昵称" value="<?php echo ($user["nickname"]); ?>" errormsg="昵称至少3个字符，最多30个字符" class="c1">
                        </dd>
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <dd class="sex">
                            <label><input type="radio" name="detail[sex]"
                                <?php if(($detail["sex"]) == "1"): ?>checked<?php endif; ?>
                                value="1" id="sex1">男</label>
                            <label><input type="radio" name="detail[sex]"
                                <?php if(($detail["sex"]) == "2"): ?>checked<?php endif; ?>
                                value="2" id="sex2">女</label>
                            <label><input type="radio" name="detail[sex]"
                                <?php if(($detail["sex"]) == "0"): ?>checked<?php endif; ?>
                ...
                <li>
                    <dl>
                        ...
                        <dd><input name="detail[birthday]" type="text" placeholder="日期如1981-08-08" datatype="*"
                                   maxlength="10"
                                   nullmsg="请输入生日" value="<?php echo ($detail["birthday"]); ?>" class="c1 laydate-icon" id="date"></dd>
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <dd><input name="detail[email]" maxlength="40" datatype="*" nullmsg="请输入电子邮箱" type="text"
                                   placeholder="请输入你的电子邮箱" value="<?php echo ($detail["email"]); ?>" class="c1" id="mail"></dd>
                    </dl>
                </li>
                <li>
                    <dl>
                ...
                <li>
                    <dl>
                        ...
                        <dd><input name="detail[address]" type="text" placeholder="请填写详细地址" class="c1" id="address"
                                   value="<?php echo ($detail["address"]); ?>"></dd>
                    </dl>
                </li>
                <li>
                    <dl>
                        ...
                        <dd><input name="detail[weibo]" type="text" placeholder="请输入你的微博地址" class="c1" id="weibo"
                                   value="<?php echo ($detail["weibo"]); ?>"></dd>
                    </dl>
                </li>
                <li>
                    <dl>
