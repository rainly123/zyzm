...
<div class="fl w100 usermain mt15">
    ...
    <ul>
        ...
        <li><a href="<?php echo U('User/applylead');?>">申请领投</a></li>
        <li><a href="<?php echo U('User/addrlist');?>">配送地址</a></li>
        <li class="cur"><a href="<?php echo U('User/savecenter');?>">安全中心</a></li>
    </ul>
  ...
  <div class="userright ri">
    <?php if($userauth["status"] != 9): ?><div class="savestep_y mt20">
        安全等级：<div class="savestep_detail"><i style="width:66%;"></i><div class="bg"></div></div><b>中</b>
      </div>
      <?php else: ?>
      <div class="savestep_g mt20">
        安全等级：<div class="savestep_detail"><i style="width:100%;"></i><div class="bg"></div></div><b>高</b>
      </div><?php endif; ?>
      <div class="savestep2 cl">
        <dl>
            <dd>
                <div><img src="/Public/Home/images/safety_09.jpg" class="c1"><b>实名认证</b><br>
                <?php if($userauth["status"] == 9): ?><img src="/Public/Home/images/safety_12.jpg" class="c2"> 已认证 <?php else: ?><img src="/Public/Home/images/safety_12.jpg" class="c2"> 未认证<?php endif; ?><a href="<?php echo U('User/realname');?>" id="popup1" data-w="500px" data-h="300px" class="poplight"><?php if($userauth["status"] == 9): ?>查看 <?php else: ?> 马上认证<?php endif; ?></a></div>
                  <div class="tips">认证成功后可进行股权项目投资</div>
              </dd>
              <dd>
                <div><img src="/Public/Home/images/safety_06.jpg" class="c1"><b>登录密码</b><br><img src="/Public/Home/images/safety_12.jpg" class="c2"> 已保障 <a href="<?php echo U('User/changepwd');?>" id="popup2" data-w="500px" data-h="340px" class="poplight">修改密码</a></div>
                  <div class="tips">您已享受会员  保障服务</div>
              </dd>
              <dd class="last">
                <div><img src="/Public/Home/images/safety_03.jpg" class="c1"><b>手机 <font style="color:#a2a2a2"><?php if(!empty($phone)): ?>(<?php echo ($phone); ?>)</font></b><br><img src="/Public/Home/images/safety_12.jpg" class="c2"> 已绑定 <a href="<?php echo U('User/changephone');?>" data-w="500px" data-h="340px" id="popup5" class="poplight">更换手机号码</a><?php else: ?><a href="<?php echo U('User/changephone');?>" data-w="500px" data-h="340px" id="popup5" class="poplight">绑定手机</a><?php endif; ?></div>
                  <div class="tips">您可享有手机相关服务</div>
              </dd>
          </dl>
      </div>
  </div>
