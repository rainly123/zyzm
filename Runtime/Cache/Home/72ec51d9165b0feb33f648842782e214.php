<?php if (!defined('THINK_PATH')) exit();?><div class="addcards mt20 cl" id="addnewaddress" style="margin:20px; 20px 0 10px">
  ...
  <form id="form-modify-addr" method="POST" action="<?php echo U('Product/modify_rule');?>">
    ...
    <ul class="list mt20">
      ...
      <dl>
      	<dt>分享人数：</dt>
      	<dd>
      	<input name="shareno" type="text" value="<?php echo ($detail["postno"]); ?>" class="c1" id="shareno">
      	(0表示不限)
      	</dd>
      </dl>
      </li>
