...
<div class="fl w100 usermain mt15">
  ...
  <ul>
    ...
    <li class="cur"><a href="<?php echo U('MCenter/pj_attach');?>">收藏的项目</a></li>
  </ul>
...
<table>
  ...
  <tbody>
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td><?php echo (time_format($vo["attach_time"],'Y-m-d H:s')); ?></td>
      <td><?php if($vo["stage"] == 0): ?>未上线
      ...
      <?php elseif($vo["stage"] == 9): ?>众筹成功<?php endif; ?></td>
      <td class="cz"><a href="<?php echo U('project/detail?id='.$vo[id]);?>" class="r">查看</a>
        <a href="<?php echo U('project/attach?id='. $vo[id]);?>" class="btnattach">删除</a></td>
