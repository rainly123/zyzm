...
<div class="agreement">
	<h1><font><?php echo ($project_name); ?></font><?php echo ($data["title"]); ?></h1>
	...
	<?php if(empty($review)): ?><form action="<?php echo U('agree');?>" class="form-horizontal" method="post">
	...
	<div class="agreement_sure">
  	<dl>
          ...
          <dd> <span>本人已认真阅读并充分理解<a class="linkOut" href="<?php echo U('Info/show?key=agreement');?>">《注册服务协议》</a>和<a class="linkOut" href="<?php echo U('Info/show?key=shenmingshu');?>">《投资风险申明书》</a>的条款与内容，本人确认具有识别及承担相关风险的能力。
          </span></dd>
		</dl>
