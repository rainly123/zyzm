...
<section id="user_main">
  <div class="user_ad">
    ...
    <div class="progress_container"><div class="progress_bar tip" title="100%"></div></div>
  </div>
  <div class="user_ad">
    <div class="user_phone">
    <?php if(empty($phone)): ?><h1>绑定手机：未绑定</h1>
      <p><a href="<?php echo U('changephone');?>">绑定</a></p>
    <?php else: ?>
      <h1>绑定手机：<?php echo ($phone); ?></h1>
      <p><a href="<?php echo U('changephone');?>">修改</a></p><?php endif; ?>
  ...
  <div class="user_ad">
    <div class="user_phone">
      <h1>登录密码：单向加密</h1>
      <p><a href="<?php echo U('changepwd');?>">修改</a></p>
    </div>
  </div>
  <div class="user_ad">
    <div class="user_phone">
    <?php if(empty($userauth)): ?><h1>实名认证：未认证</h1>
      <!-- 已认证不可修改，未认证点击认证 -->
      <p><a href="<?php echo U('realname');?>">立即验证</a></p>
    <?php else: ?>
      <h1>实名认证：已认证</h1>
      <!-- 已认证不可修改，未认证点击认证 -->
      <p><a href="<?php echo U('realname');?>">查看</a></p><?php endif; ?>
    </div>
  </div>
</section>
...
<script type="text/javascript" src="/Public/Mobile/js/jquery.tips.js"></script>
