...
<body>
    ...
    <div class="wrapper">
        <div class="investor">
            <ul>
                <?php if(is_array($investors)): foreach($investors as $key=>$investor): ?><li>
                        <em><a href="<?php echo U('MCenter/profile?id='. $investor['investor_id']);?>" class="user"><img src="<?php echo (get_memberface($investor['investor_id'])); ?>" width="50" height="50"></a></em>
                        <span class="investor-username"><?php echo (get_membername($investor['investor_id'])); ?> <i style="font-size:13px"><?php if($investor["lead_type"] == 2): ?>候选领投人<?php elseif($investor["lead_type"] == 9): ?>领投人<?php endif; ?></i></span>
                        <span class="invest-amount">投资金额: <strong><?php echo ($investor["fund"]); ?></strong>元</span>
