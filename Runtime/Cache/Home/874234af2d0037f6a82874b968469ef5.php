...
<script>
	...
	<link rel="stylesheet" type="text/css" href="/Public/Home/css/product/index.css">
	...
	<div class="banner">
	   <img src="/Public/Home/images/product/index/banner.jpg" />
	</div>
	 ...
	 <div class="main">
	     <div class="main-left">
	         ...
	         <!-- <h5><a href="#" >浏览更多项目 > </a></h5>  -->
	           ...
	           <?php if(empty($list)): ?><p class="none_info">没有当前条件的众筹项目</p>
		       <?php else: ?>

		           	<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="Module_c">
			           	<a href="<?php echo U('Product/viewDetail?pid='.$vo['id']);?>">
			           		<?php $finish_progress_bar = round($vo['finish_amount']/$vo['amount'],2)*100; if ($finish_progress_bar>100):?>
								<span class="super_raise icon_y">已超募</span>
							<?php endif; ?>
			           		<img src="<?php echo (get_cover($vo["home_img"],'path')); ?>" class="imgbox-400" title="" alt=""></a>
			           	<div class="Module_text">
			           		<div class="Module_topic">
			           			<h3>
			           				<a href="<?php echo U('Product/viewDetail?pid='.$vo['id']);?>"><?php echo ($vo["name"]); ?></a>
			           			</h3>
			           			<p title=""><?php echo ($vo["abstract"]); ?></p>
			           		</div>        
			           			<div class="Module_progress">        
			           				<span><i style="width: <?php print round($vo['finish_amount']/$vo['amount'],2)*100; ?>%"></i></span>
			           				<em class="ing"><?php echo ($vo["stage_text"]); ?></em>        
			           			</div>
			           			<div class="Module_op">        
			           				<ul>
			           					<li>
			           					...
			           					<li class="gap" style="width:100px;">
			           						<p>￥<?php echo ($vo["finish_amount"]); ?></p>
			           						<span>已筹集</span>
			           					</li>
			           					<li class="gap">
			           						<?php if($vo["stage"] < 9): ?><p><?php if ($vo['days'] - floor((time()-$vo['start_time'])/86400) >0) { print $vo['days'] - floor((time()-$vo['start_time'])/86400) ;} else { print 0;} ?>天</p><span>剩余时间</span><?php endif; ?>
			           					</li>
			           				</ul>        
			           			</div>        
			           			<div class="Module_fav">        
			           				<p>
			           					<span>关注:<?php echo ($vo["like_record"]); ?></span>
			           					<span>阅读:<?php echo ($vo["read_record"]); ?></span>
			           				</p>        
			           			</div>
			           		</div>
	   ...
	   <div class="main-right clearfix">
	      ...
	      <div class="find ">
	        ...
	        <div class="find-1">
		        <?php if(is_array($projects)): foreach($projects as $key=>$project): ?><div>
						<a href="<?php echo U('Project/detail?id='.$project['id']);?>">
							<img src="<?php echo (get_cover($project["cover"],'path')); ?>" class="imgbox-223"></a> 
						<p style="padding:10px 0;" class="text-center"><a href="<?php echo U('Project/detail?id='.$project['id']);?>"><?php echo ($project["project_name"]); ?></a></p>
					</div><?php endforeach; endif; ?>
	        </div>
