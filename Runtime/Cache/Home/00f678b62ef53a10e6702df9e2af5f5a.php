...
<body>
    ...
    <div class="user_pay">
        <ul>
            <!--<?php if(is_array($banklist)): foreach($banklist as $key=>$p): ?>-->
                <!--<li><a href="<?php echo U('Quickpay/addstep1?merorderid='. $merorderid);?>">-->
                    <!--<img src="/Public/Home/images/quickpay/pay/<?php echo ($p["logo"]); ?>">-->
                    <!--<h1><?php echo ($p["bank_name"]); ?></h1>-->
                    <!--<p><?php echo ($p["quick_remark"]); ?></p>-->
                <!--</a></li>-->
            <!--<?php endforeach; endif; ?>-->
            <!--<?php if($payinfo["allow_creditcard"] == 1): ?>-->
                <!--<li><a href="<?php echo U('Quickpay/addstep1?merorderid='.$merorderid);?>">-->
                    <!--<img src="/Public/Mobile/images/img32.jpg">-->
                    <!--<h1>使用信用卡支付</h1>-->
                    <!--<p>绝大部分银行支持信用卡快捷支付</p>-->
                <!--</a></li>-->
            <!--<?php endif; ?>-->
            <li><a href="<?php echo U('Pay/offline?merorderid='.$merorderid);?>">
                <h1>线下支付方式</h1>
                <p>通过支付宝或网银转账</p>
            </a></li>
        </ul>
