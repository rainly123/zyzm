...
<div class="fl w100 usermain mt15">
  ...
  <ul>
    <li><a href="<?php echo U('Account/index');?>">资产动态</a></li>
    <li class="cur"><a  href="<?php echo U('Account/cardlist');?>">银行卡管理</a></li>
  </ul>
...
<div class="userright2 ri">
  <div class="bankbox clearfix">
    ...
    <?php if(is_array($cards)): $i = 0; $__LIST__ = $cards;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd id="latestCard">
 			<span class="user-drawings-bank-num">尾号<?php echo substr($vo[cardno], -4);?></span>
 			<div class="banknm"><?php echo ($vo["bank_name"]); ?></div>
 		</dd><?php endforeach; endif; else: echo "" ;endif; ?>
    <?php if(empty($cards)): ?><dd id="addBankBtn" class="user-drawings-add-bank">
	    <a href="<?php echo U('Account/addcards');?>" data-w="500px" data-h="450px" class="poplight">
	    <span class="user-drawings-add-bank-txt">添加银行卡</span>
	    </a>
	  </dd><?php endif; ?>
  </div>
  <?php if(!empty($quickcards)): ?><div class="bankbox clearfix">
	  <div class="banktitle">快捷支付卡</div>
	  <?php if(is_array($quickcards)): $i = 0; $__LIST__ = $quickcards;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd id="latestCard"> 
	 		<span class="user-drawings-bank-num"><?php if(($vo["cardtype"]) == "0"): ?>信用卡<?php else: ?>借记卡<?php endif; ?> | 尾号<?php echo substr($vo[cardno], -4);?></span>
	 		<img src="<?php echo ($vo["normal_logo"]); ?>"> 
	 		<div class="tstext">
				<a href="<?php echo U('Account/delcard?type=2&id='.$vo['id']);?>">删除</a>
	 		</div>
	 	</dd><?php endforeach; endif; else: echo "" ;endif; ?>
	</div><?php endif; ?>
</div>
