...
<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><li><dl>
    ...
    <dd class="detail">
      <div class="from"><a href="<?php echo U('MCenter/profile?id='.$vo['investor_id']);?>" target="_blank"><b><?php echo (get_membername($vo["investor_id"])); ?></b></a><?php if(($vo["lead_type"]) == "9"): ?><small>领投人</small><?php endif; ?></div>
