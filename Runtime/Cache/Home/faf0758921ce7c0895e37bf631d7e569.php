            ...
            <form method="post" action="<?php echo U();?>">
                <ul>
                    <li>
                        <div class="text">
                            <i class="mobile"></i>
                            <input name="username" ajaxurl="<?php echo U('validateRegister');?>" type="text" placeholder="请输入用户名"
                    ...
                    <li>
                        <div class="text">
                            <i class="mobile"></i>
                            <input id="phoneNo" name="mobile" ajaxurl="<?php echo U('validateRegister');?>" type="text"
                    ...
                    <li>
                        <div class="text">
                            <i class="mail"></i>
                            <input name="verify" type="text" placeholder="短信验证码">
                            <input href="<?php echo U('sendsms');?>" id="cellcode_send" type="button" value="获取验证码"
