		...
		<div id="sidebar" class="sidebar">
			...
			<div id="subnav" class="subnav">
				<div id="personal">
					...
					<?php if(is_array($info_menu)): $i = 0; $__LIST__ = $info_menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo["key_word"] == $key_word): ?>class="current" <?php else: ?> class=""<?php endif; ?> >
							<a class="item" href="<?php echo U('Info/show?key='.$vo['key_word']);?>"><?php echo ($vo["title"]); ?></a>
		...
		<div class="mcenter-right" id="mcenter-right">
			...
			<div>
				<div class="bs-docs-example" style="border: none;">
					<h2 style="text-align:center"><?php echo ($info["title"]); ?></h2>
